...
// TEST SUITE A
#if defined(PHASE_A_0) | defined(PHASE_A)
...
#if defined(PHASE_A_1) | defined(PHASE_A)
...
#if defined(PHASE_A_2) | defined(PHASE_A)
...
#if defined(PHASE_A_3) | defined(PHASE_A)
...
#if defined(PHASE_A_4) | defined(PHASE_A)
...
#if defined(PHASE_A1_1) | defined(PHASE_A)
...
#if defined(PHASE_A2_1) | defined(PHASE_A)
...
TEST(PhaseA2, ReallocCopy) {
    ...
    EXPECT_GE(4, Foo::destructions);
    EXPECT_GE(3, Foo::copies);
}
#endif
